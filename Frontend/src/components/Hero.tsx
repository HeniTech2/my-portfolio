      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-6">
            <a href="mailto:heni1500896@gmail.com" className="flex items-center gap-2 text-gray-400 hover:underline">
              <Mail className="w-4 h-4 text-purple-400" />
              <span className="text-sm">heni1500896@gmail.com</span>
            </a>

            <a href="tel:+251925325154" className="flex items-center gap-2 text-gray-400 hover:underline">
              ...
              <img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    'https://ui-avatars.com/api/?name=Henok+Amare&background=8b5cf6&color=fff&bold=true&size=320'
                }}
              />
            </div>
